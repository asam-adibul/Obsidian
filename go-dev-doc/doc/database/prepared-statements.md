...
Prepare a statement for use in a specific transaction. For more, see [Executing transactions](/doc/database/execute-transactions).

`[Conn.PrepareContext](https://pkg.go.dev/database/sql#Conn.PrepareContext)`
