...
The indented lines are treated as preformatted text: they are not rewrapped and are printed in code font in HTML and Markdown presentations. (The [Syntax](#syntax) section below gives the details.)
...
The [`go/ast.ParseDirective`](/pkg/go/ast#ParseDirective) function and its related types parse the tool directive syntax.
